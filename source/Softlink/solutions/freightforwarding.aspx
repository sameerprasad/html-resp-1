<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" AutoEventWireup="true" CodeFile="freightforwarding.aspx.cs" Inherits="freightforwarding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container slider-container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-slider">
                  <img src="/images/sliders/Freight Forwarding 1.png" class="carousel-img-item" width="100%" />
            </div>
        </div>
    </div>
   ...
   <div class="container content-container">
    ...
    <uc1:solution ID="solution1" No="2" runat="server" />
</asp:Content>
